...
var SquareMeterInfo = function SquareMeterInfo(props) {
  var info = props.info;
  return React__default.createElement("span", null, info || '---', "\xA0", info && '㎡');
};
var defaultKayMap = {
...
var HouseType = function HouseType(props) {
  ...
  return React__default.createElement("span", null, "".concat(bedroom, "\u5BA4").concat(livingRoom, "\u5385").concat(kitchen, "\u53A8").concat(bathroom, "\u536B").concat(balconyNum, "\u9633\u53F0"));
};
...
var AreaInfo = function AreaInfo(props) {
  ...
  return React__default.createElement("span", null, "".concat(province).concat(city).concat(district), "\xA0\xA0", address || null);
};
var UpLoadInfo = function UpLoadInfo(props) {
  ...
  return React__default.createElement(React.Fragment, null, data.map(function (ele, i) {
    var extendStyle = {};
...
var VideoList = function VideoList(props) {
  ...
  return React__default.createElement(React.Fragment, null, list.map(function (ele, i) {
    var extendStyle = {
      width: 160,
      height: 120,
      style: {}
...
var UploadPreview = function UploadPreview(props) {
  ...
  }), params.type === 'video' ? React__default.createElement(VideoList, {
    list: list[0],
    style: _objectSpread2({}, innerStyle)
  }) : React__default.createElement(UpLoadInfo, {
    style: _objectSpread2({}, innerStyle),
    noHref: true,
    data: list[0]
...
var TitleInfo = function TitleInfo(props) {
  ...
  return React__default.createElement("span", _extends({}, rest, {
    title: info
  }), tit);
};
...
var getColorWrapper = function getColorWrapper(props) {
  var info = props.info;
  return info ? React__default.createElement(BuleWrapper, props) : null;
};
var ShowMoreInfo = function ShowMoreInfo(props) {
  ...
  return React__default.createElement("span", null, showInfo, " ", needSubstring ? React__default.createElement("span", {
    className: "likeA",
    onClick: function onClick() {
      return showMore();
    }
...
var HouseDesc = function HouseDesc(props) {
  var buildingNo = props.buildingNo,
      unitNo = props.unitNo,
      roomNo = props.roomNo;
  return React__default.createElement("span", null, "".concat(buildingNo || '--', "\u5E62").concat(unitNo || '--', "\u5355\u5143").concat(roomNo || '--', "\u5BA4"));
};
var SomeRed = function SomeRed(props) {
  ...
  return React__default.createElement("span", null, start, React__default.createElement("span", {
    style: {
      color: 'red'
    }
  }, keyWord), end);
...
var LRInfo = function LRInfo(props) {
  ...
  if (!title) {
    return React__default.createElement("div", infoProps, info);
  }
  ...
  return React__default.createElement("div", {
    ...
    className: "g0"
  }, titleProps), title || ' -- ', "\xA0", hasColon ? ':' : null, " \xA0"), React__default.createElement("div", _extends({
    className: "df flex1"
...
var BuildingArea = function BuildingArea(props) {
  ...
  return React__default.createElement("span", null, "".concat(buildingName || '--').concat(houseCode ? "".concat(houseCode, "\u6237\u578B") : ''), " ", React__default.createElement("br", null), " ", buildingNo ? "".concat(buildingNo || '--', "\u680B").concat(unitNo || '--', "\u5355\u5143").concat(roomNo || '--', "\u5BA4") : '');
};
